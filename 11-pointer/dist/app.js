...
eval("module.exports = {\r\n    create\r\n}\r\n\r\n\r\nfunction create(repository, renderer, events = {}, doc, win) {\r\n    const user = (__webpack_require__(/*! ./user */ \"../../core/events/user.js\").create)(repository, renderer, doc, events.user);\r\n    const document = (__webpack_require__(/*! ./document */ \"../../core/events/document.js\").create)(repository, doc, events.document);\r\n    const window = (__webpack_require__(/*! ./window */ \"../../core/events/window.js\").create)(renderer, win, events.window);\r\n\r\n    return {\r\n        user,\r\n        document,\r\n        window,\r\n        destroy\r\n    }\r\n\r\n    function destroy() {\r\n        user.destroy();\r\n        document.destroy();\r\n        window.destroy();\r\n    }\r\n}\n\n//# sourceURL=webpack:///../../core/events/events.js?");
...
"use strict";
eval("module.exports = JSON.parse('{\"models\":[{\"key\":\"pointer\",\"value\":1}],\"views\":[{\"mKey\":\"pointer\",\"component\":\"Pointer\",\"parentPath\":\"body\"}]}');\n\n//# sourceURL=webpack:///./src/data.json?");
