...
eval("const event = {\r\n    application: {\r\n        Create: 'create',\r\n        Init: 'init',\r\n        Refresh: 'refresh',\r\n        Update: 'update'\r\n    },\r\n\r\n}\r\nObject.freeze(event);\r\n\r\nconst request = {\r\n    types: {\r\n        Json: 'json',\r\n        Page: 'page',\r\n        File: 'file'\r\n    },\r\n    method: {\r\n        Post: 'post',\r\n        Get: 'get'\r\n    }\r\n}\r\nObject.freeze(request);\r\n\r\n\r\nmodule.exports = {\r\n    event,\r\n    request\r\n}\n\n//# sourceURL=webpack:///../../Core/src/shared/types.js?");
...
eval("module.exports = {\r\n    create\r\n}\r\n\r\nfunction create(onLoad, onError) {\r\n    return {\r\n        request\r\n    }\r\n\r\n\r\n\r\n    function request(params) {\r\n        switch (params.type.toLowerCase()) {\r\n            case 'post':\r\n                post(params)\r\n                return;\r\n        }\r\n        onError('post not implemented', params);\r\n\r\n        function post(params) {\r\n            const a = __webpack_require__(/*! ./data/a.json */ \"./src/data/a.json\");\r\n            const b = __webpack_require__(/*! ./data/b.json */ \"./src/data/b.json\");\r\n            const c = __webpack_require__(/*! ./data/c.json */ \"./src/data/c.json\");\r\n            const home = __webpack_require__(/*! ./data/default.json */ \"./src/data/default.json\");\r\n\r\n            let data;\r\n            switch (params.uri) {\r\n                case 'page-default':\r\n                    data = home;\r\n                    break;\r\n                case 'page-a':\r\n                    data = a;\r\n                    break;\r\n                case 'page-b':\r\n                    data = b;\r\n                    break;\r\n                case 'page-c':\r\n                    data = c;\r\n                    break;\r\n                default:\r\n                    onError('invalid page name');\r\n                    break;\r\n            }\r\n\r\n            onLoad({\r\n                models: [data]\r\n            });\r\n        }\r\n    }\r\n}\n\n//# sourceURL=webpack:///./src/request.js?");
...
"use strict";
eval("module.exports = JSON.parse('{\"key\":\"c\",\"value\":\"Page A: \\\\nin reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.\"}');\n\n//# sourceURL=webpack:///./src/data/a.json?");
...
"use strict";
eval("module.exports = JSON.parse('{\"key\":\"c\",\"value\":\"Page B: \\\\npariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui offin reprehenderit in voluptate velit esse cillum dolore eu fugiat nullaicia deserunt mollit anim id est laborum.\"}');\n\n//# sourceURL=webpack:///./src/data/b.json?");
...
"use strict";
eval("module.exports = JSON.parse('{\"key\":\"c\",\"value\":\"Page C: \\\\npdolore eu fugiat nullaicia deserunt mollit anim id est laborum.ariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui offin reprehenderit in voluptate velit esse cillum \"}');\n\n//# sourceURL=webpack:///./src/data/c.json?");
...
"use strict";
eval("module.exports = JSON.parse('{\"key\":\"c\",\"value\":\"Home Page: \\\\nLorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.\"}');\n\n//# sourceURL=webpack:///./src/data/default.json?");
...
"use strict";
eval("module.exports = JSON.parse('{\"layouts\":[{\"name\":\"basic-layout\",\"parentPath\":\"body\"}],\"models\":[{\"key\":\"a\",\"value\":\"Page Title\"},{\"key\":\"b1\",\"value\":\"Link A\"},{\"key\":\"b2\",\"value\":\"Link B\"},{\"key\":\"b3\",\"value\":\"Link C\"},{\"key\":\"c\",\"value\":\"Home Page: \\\\nLorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.\"}],\"viewModels\":[{\"key\":\"va\",\"value\":3}],\"views\":[{\"mKey\":\"a\",\"vmKey\":\"va\",\"component\":\"Hx\",\"parentPath\":\".section-a\",\"request\":{\"type\":\"post\",\"uri\":\"page-default\",\"data\":{}}},{\"mKey\":\"b1\",\"component\":\"A\",\"parentPath\":\".section-b\",\"request\":{\"type\":\"post\",\"uri\":\"page-a\",\"data\":{}}},{\"mKey\":\"b2\",\"component\":\"A\",\"parentPath\":\".section-b\",\"request\":{\"type\":\"post\",\"uri\":\"page-b\",\"data\":{}}},{\"mKey\":\"b3\",\"component\":\"A\",\"parentPath\":\".section-b\",\"request\":{\"type\":\"post\",\"uri\":\"page-c\",\"data\":{}}},{\"mKey\":\"c\",\"component\":\"Paragraph\",\"parentPath\":\".section-c\"}]}');\n\n//# sourceURL=webpack:///./src/data/home.json?");
