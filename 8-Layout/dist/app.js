...
eval("module.exports = {\r\n    create\r\n}\r\n\r\n\r\nfunction create(repository, renderer, events = {}, doc, win) {\r\n    const _user = (__webpack_require__(/*! ./user */ \"../../core/events/user.js\").create)(repository, renderer, doc, events.user);\r\n    const _document = (__webpack_require__(/*! ./document */ \"../../core/events/document.js\").create)(repository, doc, events.document);\r\n    const _window = (__webpack_require__(/*! ./window */ \"../../core/events/window.js\").create)(renderer, win, events.window);\r\n\r\n    return {\r\n        user: _user,\r\n        document: _document,\r\n        window: _window,\r\n        destroy\r\n    }\r\n\r\n    function destroy() {\r\n        _user.destroy();\r\n        _document.destroy();\r\n        _window.destroy();\r\n    }\r\n}\n\n//# sourceURL=webpack:///../../core/events/events.js?");
